im1 = im2double(imread('../TestImages/NewBackGround.png'));
%im2 = im2double(imread('../TestImages/BearInWater.png'));
im2 = im2double(imread('../TestImages/GirlInWater.png'));
...
% hToolWarp2 = uipushtool('CData', reshape(repmat([0 1 0], 100, 1), [10 10 3]), 'TooltipString', 'compute blended image on time', 'ClickedCallback', @toolPasteCB2);
